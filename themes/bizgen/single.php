<?php
    ...
    <div id="content">
        ...
        if(!empty($bizgen_option['s_blog_layout'])){
            $page_layout = $bizgen_option['s_blog_layout'];
        }
        else{
            ...
            <div class="row padding-<?php echo esc_attr( $col_letf) ?>">
                <div class="col-lg-<?php echo esc_attr( $col_side). ' ' .esc_attr( $col_letf) ?>">
                    <div class="news-details-inner">
                        ...
                        <?php                    
                            $author_data = !empty($bizgen_option['blog-author']) ? $bizgen_option['blog-author'] : '';
                        ...
                        if($blog_author == ""){
                            ...
                            {
                            $blog_author = $bizgen_option['blog-comments'];
                            if($blog_author == 'show'){     
