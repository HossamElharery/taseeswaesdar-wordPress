...
$preloader_img = "";
if(!empty($bizgen_option['show_preloader']))
  {
    $loading = $bizgen_option['show_preloader'];
    
    if(!empty($bizgen_option['preloader_img'])){
        $preloader_img = $bizgen_option['preloader_img'];
    }
...
<?php 
    if(!empty($bizgen_option['off_sticky'])):   
        $sticky = $bizgen_option['off_sticky'];         
        if($sticky == 1):
