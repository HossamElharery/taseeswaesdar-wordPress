			...
			<div class="container">
				<div class="ps-navigation">
					...
					<?php			 
						...
						?>
					<div class="rts-left-write-blog-wrapper-main d-flex">
						<?php if($next_post):?>	
					
							<div class="left-icon-area single d-flex">
								<div class="icon-1">
								...
								<a href="<?php echo esc_url( $url_next ) ?>"><span><?php echo esc_html__('Previous', 'bizgen'); ?></span>
									<span class="title">
						...
						<div class="right-icon-area single d-flex">
                            <div class="writing-content">
							<a href="<?php echo esc_url( $url_previous ) ?>"><span><?php echo esc_html__('Next', 'bizgen'); ?></span>
                                <span class="title">
								<?php echo esc_attr( $title ); ?>
                                <span></a>
                            </div>
