...
class ReacThemes_Logo_Showcase_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'dark_image',
            [
                'label' => esc_html__('Dark Logo', 'rtelements'),
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => Utils::get_placeholder_image_src(),
                ],
            ...
            <div class="rs-logo-grid logo-grid-<?php echo esc_attr($settings['logo_grid_style']); ?>">
                ...
                <?php
                    foreach ( $settings['logo_list'] as $index => $item ) :
                        ...
                        $dark_image = wp_get_attachment_image_url( $item['dark_image']['id'], $settings['thumbnail_size'] );
                        ...
                        <div class="col-xxl-<?php echo esc_attr($settings['columns']);?> col-lg-2 col-md-2 col-6 <?php echo esc_attr( $gap );?>">
                            <div  class="rt-grid-figure">
                                <div class="logo-img">
                                    <a href="<?php echo esc_url($link);?>" <?php echo wp_kses_post($target);?> class="front<?php echo esc_attr( $backExists ); ?>">

                                        <?php if(!empty($image )):?>
                                            <img class="rs-grid-img <?php echo esc_attr( $animation ); ?>" <?php echo esc_attr( $show_tooltip );?> src="<?php echo esc_url( $image ); ?>" title="<?php echo esc_attr( $item['name'] ); ?>" alt="<?php echo esc_attr( $item['name'] ); ?>">
                                        <?php endif;?>
                                        <?php if(!empty($dark_image )):?>
                                            <img class="dark-rs-grid-img <?php echo esc_attr( $animation ); ?>" <?php echo esc_attr( $show_tooltip );?> src="<?php echo esc_url( $dark_image ); ?>" title="<?php echo esc_attr( $item['name'] ); ?>" alt="<?php echo esc_attr( $item['name'] ); ?>">
                                        <?php endif;?>
                                    </a>
