...
class ReacTheme_Breadrumb_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'custom_des',
            [
                'label'       => esc_html__( 'Custom Description', 'pielements' ),
    ...
    protected function render() {
        ...
        $custom_home_title = isset($settings['custom_home_title']) ? $settings['custom_home_title'] : '';
        $custom_title = isset($settings['custom_title']) ? $settings['custom_title'] : '';
        $custom_des = isset($settings['custom_des']) ? $settings['custom_des'] : 'dsfsd';
        $custom_path = isset($settings['custom_path']) ? $settings['custom_path'] : '';
        $search_custom_title = isset($settings['search_custom_title']) ? $settings['search_custom_title'] : '';
        $search_result_title = isset($settings['search_result_title']) ? $settings['search_result_title'] : '';
        $separator_icon = isset($settings['separator_icon']) ? $settings['separator_icon'] : '';


        echo get_rt_breadcrumb($custom_title, $custom_des, $custom_path, $separator_icon, $custom_home_title, $search_custom_title,$search_result_title );
