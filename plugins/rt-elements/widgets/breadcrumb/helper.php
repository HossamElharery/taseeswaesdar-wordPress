...
function get_rt_breadcrumb($custom_title='', $custom_des ='', $custom_path='', $custom_separator='', $custom_home_title='', $search_custom_title='', $search_result_title=''){    

    global $post;
    $post = get_queried_object();
    $object_id = get_queried_object_id();
    $title = !empty($custom_title) ? $custom_title : get_the_title($object_id);
    ...
    $home_link = '<a href="' . esc_url(home_url('/')) . '">' . __($home_title, 'rtaddon') . '</a>';
    $breadcrumb_path = '';
    ...
    <div class="breadcrumb-inner-addon">
        <div class="rt-title-part">
            ...
            <?php echo wp_kses_post($custom_des); ?>
        </div>
        <div class="breadcrumb-path">
                ...
                if (is_single()) {
                    ...
                    $output .= $separator. get_the_title($post->ID);
