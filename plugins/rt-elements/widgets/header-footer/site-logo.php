...
class RTS_Site_Logo extends Widget_Base {
	...
	protected function register_content_site_logo_controls() {
		...
		$this->start_controls_section(
			'section_dark_logo_section',
			[
				'label' => __( 'Dark Logo', 'rtelements' ),
			]
		);
		$this->add_control(
			'section_dark_logo',
	...
	protected function render() {
		...
		if ( ! empty( $settings['custom_dark_logo']['url'] ) ) {
			$image_data3 = wp_get_attachment_image_src( $settings['custom_dark_logo']['id'], $image_size, true );
			$hide_desktop_logo =  'hide_logo_desktop';
		}
		...
		if ( ! empty( $image_data3 ) ) {
			$image_url3 = $image_data3[0];
		}
		...
		?>
			<div class="hfe-site-logo-set">           
				<div class="hfe-site-logo-container">
					...
					<img class="hfe-dark-logo-img"  src="<?php echo esc_url($image_url3); ?>" alt="<?php echo esc_attr( Control_Media::get_image_alt( $settings['custom_dark_logo'] ) ); ?>"/>
