					...
					$this->add_control(
						...
						[
							...
							'selectors' => [
								...
								'{{WRAPPER}} .menu-area .navbar ul li:hover > a' => 'color: {{VALUE}} !important',								
								'{{WRAPPER}} .menu-area .navbar ul li:hover > a::before' => 'color: {{VALUE}} !important',								
							],
						]
					);					
					...
					$this->add_control(
						...
						[
							...
							'selectors' => [
								...
								{{WRAPPER}} .menu-area .navbar ul li.current-menu-ancestor a' => 'color: {{VALUE}} !important',
							],
						]
					);
					...
					$this->add_control(
						...
						[
							...
							'selectors' => [
								...
								'{{WRAPPER}} .sticky-menu.menu-area .navbar ul li a::before' => 'color: {{VALUE}}',
							],
						]
					);
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .sticky-menu.menu-area .navbar ul li:hover > a' => 'color: {{VALUE}}',
								'{{WRAPPER}} .sticky-menu.menu-area .navbar ul li:hover > a::before' => 'color: {{VALUE}}',
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .sticky-menu.menu-area .navbar ul li.current-menu-item a' => 'color: {{VALUE}}',
								'{{WRAPPER}} .sticky-menu.menu-area .navbar ul li.current-menu-item a::before' => 'color: {{VALUE}} ',
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'default'   => '',
							'selectors' => [
								'{{WRAPPER}} .menu-area .navbar ul li ul.sub-menu li a' => 'color: {{VALUE}} !important',
							],
						]
					);
					$this->add_control(
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'default'   => '',
							'selectors' => [
								'{{WRAPPER}} .menu-area .navbar ul li ul.sub-menu li:hover a' => 'background-color: {{VALUE}} !important',
							],
