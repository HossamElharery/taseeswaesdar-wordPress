...
defined('ABSPATH') || die();
class Reactheme_Elementor_Slider_mission_Widget  extends \Elementor\Widget_Base {
    ...
    {
        return esc_html__('RT Mission Slider', 'rtelements');
    }
    ...
    protected function register_controls(){
        ...
        $this->add_control(
            ...
            [
                ...
                'title_field' => '{{{ name }}}',
                'default' => [
                    ['name' => 'We identify inefficiencies'],
                    ['name' => 'We identify inefficiencies'],
                    ['name' => 'We identify inefficiencies'],
                ]
            ]
    ...
    protected function render()
    {
        ...
        <div class="rts-mission-area-one">
