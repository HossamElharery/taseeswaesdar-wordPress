...
class ReacThemes_Elementor_Heading_dual_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'animation_enable',
			[
				'label' => esc_html__( 'Spilt Text', 'rsaddon' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'true' => esc_html__( 'Yes', 'rsaddon' ),
				'false' => esc_html__( 'No', 'rsaddon' ),
				'return_value' => 'true',
				'default' => 'false',
			]
		);
		...
		$this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-dual-heading .title-inner .first_title' => 'color: {{VALUE}};',
                ],                
            ]
        );
		...
		$this->add_control(
            'des_styles',
            [
                'label' => esc_html__( 'Description Styles', 'rsaddon' ),
		...
		$this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-dual-heading .description p' => 'color: {{VALUE}};',
                ],                
            ]
        ); 	
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .rs-dual-heading .description p',
			]
		);	
		$this->add_responsive_control(
		    'des_padding',
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .rs-dual-heading .description p' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .rs-dual-heading .description p' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
	...
	protected function render() {
		...
		$spilt_text = $settings['animation_enable'] === 'true' ? 'split_collab' : '';
		$watermark_text = ($settings['watermark']) ? '<span class="watermark">'.($settings['watermark']).'</span>' : '';
		$show_color_title = ($settings['color_title']) ? ' <span class="second_title ' . esc_attr($spilt_text) . ' ">'.($settings['color_title']).'</span>' : '';

		$main_title = ($settings['title']) ? '<' . $settings['title_tag'] . ' class="title">' . $watermark_text . '<span class="first_title ' . esc_attr($spilt_text) . '">' . wp_kses_post($settings['title']) . '</span>' . $show_color_title . '</' . $settings['title_tag'] . '>' : '';
