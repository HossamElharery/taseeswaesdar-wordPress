...
final class RTelements_Elementor_Extension {
	...
	public function rsaddon_register_plugin_styles() {		
        ...
        wp_enqueue_script( 'rtaddons-custom-pro', $dir.'assets/js/custom.js', array('jquery', 'imagesloaded'), '201513434', true);       	
    }


    public function rsaddon_register_plugin_admin_styles(){
    	$dir = plugin_dir_url(__FILE__);
    	wp_enqueue_style( 'rtaddons-admin-pro', $dir.'assets/css/admin/admin.css' );
    	wp_enqueue_style( 'rtaddons-admin-floaticon-pro', $dir.'assets/fonts/flaticon.css' );
    } 

    public function rsaddon_admin_defualt_css(){
    	$dir = plugin_dir_url(__FILE__);
    	wp_enqueue_style( 'rtaddons-admin-pro-style', $dir.'assets/css/admin/style.css' );    	
    }
	...
	public function init_widgets() {
		...
		\Elementor\Plugin::instance()->widgets_manager->register( new \ReacTheme_Elementor_Services_Grid_Widget() );
		 ...
		 //service Slider
		require_once( __DIR__ . '/widgets/service-slider/slider.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Reactheme_Elementor_Service_Slider_Widget() );	
		...
		\Elementor\Plugin::instance()->widgets_manager->register( new \Reactheme_Elementor_Slidertestimoanil_Widget() );
	
		//Mission
		require_once( __DIR__ . '/widgets/mission/mission.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Reactheme_Elementor_Slider_mission_Widget() );
		...
		//blog list        
		require_once( __DIR__ . '/widgets/recent-post/recent-post.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \RTS_recent_post_list_() );
		...
		//portfolio slider
		include_once( __DIR__ . '/widgets/portfolio-slider/portfolio-slider-widget.php' );
